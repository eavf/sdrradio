...
import tagging_epy_block_0 as epy_block_0  # embedded python block
import tagging_epy_block_1 as epy_block_1  # embedded python block



from gnuradio import qtgui

class tagging(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "tagging")
...
def main(top_block_cls=tagging, options=None):
