...
class LPFilterex(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._frequency_range = Range(-samp_rate/2, samp_rate/2, 1, 0, 500)
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(1, boxcarFilter, 0, samp_rate)
    ...
    def set_boxcarFilter(self, boxcarFilter):
        ...
        self.freq_xlating_fir_filter_xxx_0.set_taps(self.boxcarFilter)
