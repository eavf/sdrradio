...
class sample rate change(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "sample rate change")
...
def main(top_block_cls=sample rate change, options=None):
