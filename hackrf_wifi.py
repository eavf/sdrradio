...
class hackrf_wifi(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "hackrf_wifi")
        ...
        self.channel_freq = channel_freq = 104.3e6
        self.center_freq = center_freq = 102.7e6
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(8e6, analog.GR_COS_WAVE, 1.4e6, 1, 0, 0)
...
def main(top_block_cls=hackrf_wifi, options=None):
