...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.channel_slider = channel_slider = center_freq+channel_width/2

        ##################################################
        # Blocks
        ##################################################

        self._volume_slider_range = Range(0, 10, 1, 5, 200)
        ...
        self._channel_slider_range = Range(center_freq-samp_rate/2+channel_width/2, center_freq+samp_rate/2-channel_width/2, 100, center_freq+channel_width/2, 200)
        self._channel_slider_win = RangeWidget(self._channel_slider_range, self.set_channel_slider, "Chanel", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.top_layout.addWidget(self._stat_chooser_tool_bar)
        ...
        self.connect((self.soapy_hackrf_source_0, 0), (self.qtgui_sink_x_0_0, 0))
    ...
    def set_channel_width(self, channel_width):
        ...
        self.set_channel_slider(self.center_freq+self.channel_width/2)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 75e3, 2e3, window.WIN_HAMMING, 6.76))
    ...
    def set_channel_slider(self, channel_slider):
        ...
        self.qtgui_sink_x_0.set_frequency_range(0, self.channel_slider)
        self.qtgui_sink_x_0_0.set_frequency_range(0, self.channel_slider)
