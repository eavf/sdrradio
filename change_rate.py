...
class change_rate(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "change_rate")
        ...
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate_interpolated,True)
    ...
    def set_samp_rate_interpolated(self, samp_rate_interpolated):
        ...
        self.set_lowPassTaps(firdes.low_pass(1.0, self.samp_rate_interpolated, self.samp_rate_interpolated/(self.interpolation_rate*2), self.samp_rate_interpolated/(self.interpolation_rate*4), window.WIN_HAMMING, 6.76))
        self.blocks_throttle_0.set_sample_rate(self.samp_rate_interpolated)
        self.qtgui_freq_sink_x_0.set_frequency_range(self.frequency, self.samp_rate_interpolated)
...
def main(top_block_cls=change_rate, options=None):
